...
tap.test("uci", function (t) {
  ...
  t.equal(
    chess.uci({ from: "a7", to: "a8", flags: "p", piece: "q" }),
    "a7a8q",
...
tap.test("manhattanDistance", function (t) {
  ...
  t.equal(
    chess.manhattanDistance(a1, a8),
    7,
    "7 manhattanDistance between a1 a8"
  )
  t.equal(
    chess.manhattanDistance(a1, b8),
    8,
    "8 manhattanDistance between a1 a8"
  )
  t.end()
})
...
tap.test("euclideanDistance", function (t) {
  ...
  t.equal(
    chess.euclideanDistance(a1, a8),
    7,
    "7 euclideanDistance between a1 a8"
  )
  t.equal(
    chess.euclideanDistance(a1, b8),
    Math.sqrt(7 * 7 + 1),
    "7.071 euclideanDistance between a1 a8"
  )
  t.end()
})
