...
test("distanceMetric", function (t) {
  ...
  t.equals(
    player.distanceMetric(chess, opponentsKingSquare, colour),
    120,
    "distance to king metric is 120"
  )
  chess.applyMoves(["e2e4"])
  t.equals(
    player.distanceMetric(chess, opponentsKingSquare, colour),
    122,
    "distance to king metric is 122"
  )
  chess.applyMoves(["a7a6"])
  t.equals(
    player.distanceMetric(chess, opponentsKingSquare, colour),
    122,
    "distance to king invariant to opponents move"
  )
  t.end()
})
